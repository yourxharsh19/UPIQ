...
public class TransactionController {
        ...
        public ResponseEntity<ApiResponse<TransactionResponse>> updateTransaction(
                        ...
                        @Valid @RequestBody CreateTransactionRequest request,
                        @RequestHeader("X-User-Id") Long userId) {
                TransactionResponse updated = service.updateTransaction(id, request, userId);
                ApiResponse<TransactionResponse> response = ApiResponse.<TransactionResponse>builder()
                                .success(true)
                                .data(updated)
        ...
        @DeleteMapping
        public ResponseEntity<ApiResponse<String>> deleteAllTransactions(@RequestHeader("X-User-Id") Long userId) {
